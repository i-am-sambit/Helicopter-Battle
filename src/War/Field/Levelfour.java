...
public class Levelfour extends JFrame implements Runnable,KeyListener,MouseListener
{
...
//                    Logger.getLogger(MainGame.class.getName()).log(Level.SEVERE, null, ex);
                ...
                else
                {
                    ...
                    levelcomplete = true;
                    JLabel over = new JLabel();
                    over.setText("Congratulation !!!   You won the battle");
                    over.setFont(new Font("David",3,35));
    ...
    public void mousePressed(MouseEvent e) 
    {
        if(gameover == false)
        {
            ...
            else if(mousecode == MouseEvent.BUTTON3 && playerbomb == false)
            {
                bom--;
                if(bom>0)
                {
