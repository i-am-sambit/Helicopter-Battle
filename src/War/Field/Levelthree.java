...
public class Levelthree extends JFrame implements Runnable,KeyListener,MouseListener
{
    ...
    JLabel status,rocketstatus,enemystatus,enemystatus1,tankstatus,gamestatus,rockavailstatus,bombavailstatus,gameinfo;
    ...
    int hx = 0,hy = 350;
    int health = 100,roc,bom = 5, dest = 0, left = 0, tankdest = 0;
    ...
    private void initComp(int bal, int rokt)
    {
        Background(bal,rokt);
        this.setLayout(null);
    ...
    private void Background(int bal, int rokt)
    {
        ground1 = new JLabel();
        ground2 = new JLabel();
        ...
        rocketstatus.setText("Rockets "+rokt);
        ...
        bomstatus.setFont(new Font("David", 3, 25));
        bomstatus.setBounds(10, 90, 250, 50);
        
        enemystatus = new JLabel();
        enemystatus.setText("Destroyed  "+dest);
        enemystatus.setFont(new Font("David",3, 25));
        enemystatus.setBounds(10, 130, 250, 50);
        
        enemystatus1 = new JLabel();
        enemystatus1.setText("Runaway "+left);
        enemystatus1.setFont(new Font("David",3, 25));
        enemystatus1.setBounds(10, 170, 250, 50);
        
        tankstatus = new JLabel();
        tankstatus.setText("Tank Destroyed "+tankdest);
        tankstatus.setFont(new Font("David",3, 25));
        tankstatus.setBounds(10, 210, 250, 50);
        
        rockavailstatus = new JLabel();
        rockavailstatus.setText("Rocket Available");
        rockavailstatus.setFont(new Font("David",3, 25));
        rockavailstatus.setBounds(10, 250, 250, 50);
        
        bombavailstatus = new JLabel();
        bombavailstatus.setText("Bomb Available");
        bombavailstatus.setFont(new Font("David",3, 25));
        bombavailstatus.setBounds(10, 290, 250, 50);
        
        balance = bal;
        
        gamestatus = new JLabel();
        gamestatus.setText(" SPACE : pause       R : restart        BALANCE : "+balance+" ");
        ...
        gameinfo = new JLabel();
        gameinfo.setText("Right Click to activate to bomb attack");
    ...
    private void setenemy()
    {
        ...
        {
            enemyplayer.setBounds(enemypoint.x - 4, enemypoint.y, 270, 70);
            enemypropeller.setBounds((enemypoint.x+5) - 4, enemypoint.y - 10, 150, 40);
        }
        else 
        {
            enemydead = false;
...
//                    Logger.getLogger(MainGame.class.getName()).log(Level.SEVERE, null, ex);
                ...
                else
                {
                    ...
                    gameover = true;
                    JLabel over = new JLabel();
                    over.setText("Level 3 Completed!!! Press ENTER to go next Level");
                    over.setFont(new Font("David",3,35));
    ...
    public void setplayerbomb(int x, int y)
    {
        ...
        else if(x >= enemytank.getLocation().getX())
        {
            enbomb = false;
    ...
    public void keyPressed(KeyEvent e) 
    {
        ...
        if(levelcomplete == true)
        {
            ...
            {
                dispose();
                new Score(balance,dest,left,roc,3,tankdest);
            }
        }
    }
    ...
    public void mousePressed(MouseEvent e) 
    {
        if(gameover == false)
        {
            ...
            if(mousecode == MouseEvent.BUTTON1 && rocketavail == false)
            {
                ...
                {
                    rocketstatus.setText("Rockets > Out of Stock");
                }
            }
            else
            {
            ...
            if(mousecode == MouseEvent.BUTTON3 && playerbomb == false)
            {
                bom--;
                if(bom>0)
                {
                    ...
                    bomstatus.setText("Bomb > "+bom);
                }
                else
                {
                    bomstatus.setText("Bomb > Out of stock");
                }
            }
        }
    }
