...
public class Leveltwo extends JFrame implements Runnable,KeyListener,MouseListener
{
    ...
    JLabel status,rocketstatus,enemystatus,enemystatus1,gamestatus,rockavailstatus;
    JLabel rocket,smoke,explosion,enemyrocket;
    Thread thread;
    
    int gx1=0,gx2=1350,mx1=0,mx2=1125,mx3=2250,cloudx1=0,cloudx2=1000,cloudx3=2000;
    int gy1=610,my1=550,cloudy1 = 0;
    int hx = 0,hy = 350;
    int health = 100,roc, dest = 0, left = 0;
    int balance = 0;
    ...
    private void Background(int bal, int rokt)
    {
        ...
        enemystatus1.setBounds(10, 130, 250, 50);
    ...
    private void setenemy()
    {
        ...
        {
            enemyplayer.setBounds(enemypoint.x - 3, enemypoint.y, 270, 70);
            enemypropeller.setBounds((enemypoint.x+5) - 3, enemypoint.y - 10, 150, 40);
        }
        else 
        {
            enemydead = false;
        ...
        if(rocketavail == true)
        {
                    ...
                    rock.x+8 == enemypoint.x || rock.x-8 == enemypoint.x))
            {
                ...
                else
                {
                    ...
                    gameover = true;
                    JLabel over = new JLabel();
                    over.setText("Level 2 Completed Press ENTER to Next");
                    over.setFont(new Font("David",3,35));
    ...
    public void keyPressed(KeyEvent e) 
    {
        ...
        if(levelcomplete == true)
        {
            ...
            {
                dispose();
                new Score(balance,dest,left,roc,2,0);
            }
        }
    }
